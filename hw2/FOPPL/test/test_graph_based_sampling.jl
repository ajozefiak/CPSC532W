...
include("../graph_based_sampling.jl")
include("../read_json.jl")

# Deterministic Tests
@testset "Deterministic Tests" begin

    test_path = "output/graph/deterministic/test_"
...
@testset "Probabilistic Tests" begin
    ...
    test_path = "output/graph/probabilistic/test_"
    ...
    @testset "Standard Distributions" begin
        for i in [1 2 3 4 6]
            ...
            samples = get_samples_graph(ast,num_samples)
